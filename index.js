...
conmenu = fs.readFileSync('./X2/RAMDANI OFFICIAL.jpeg')
...
audio20 = fs.readFileSync('./X3/nayla20.m4a') 
            ...
            const nnnyz6 = {contentText: `[ *SELAMAT DATANG* ]\n${tz} *NAME* : @${memJid.split('@')[0]}\n${tz} *GROUP* : ${mdata.subject}\n${tz} *MEMBER* : ${jumlahMem.length}`, footerText: `© Creator by ALIF ANANTA || 2022`, buttons: nnnyz5, headerType: 6, locationMessage: nnnyz4.message.locationMessage}
		...
		//	if (nay.key.fromMe) return
		    ...
		    case 'menu': case 'help':
		    if (isBanned) return reply("MAAF ANDA TELAH DI BANNED")
		  	Reply("MENAMPILKAN MENU ALIF ANANTA BOT")	
			menu3 = `⚯⚯[ *ALIF ANANTA BOTZ* ]⚯⚯
HALOO!! ${codename}👋
